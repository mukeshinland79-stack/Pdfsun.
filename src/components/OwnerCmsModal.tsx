...
const DEFAULT_EDITABLE_FIELDS: CmsEditableField[] = [
  ...
  { key: "nav.searchBtn", label: "Nav: Search Button", category: "header", defaultValue: "Search 66+ Tools" },
  ...
  { key: "hero.searchPlaceholder", label: "Hero: Search Placeholder", category: "hero", defaultValue: "Search 66+ PDF tools (Ctrl+K)..." },
  ...
  { key: "badges.utilitiesTitle", label: "Badge: Utilities Count", category: "hero", defaultValue: "66+ Pro PDF Utilities" },
  ...
  { key: "faq.a3", label: "FAQ A3: Free Answer", category: "faq", defaultValue: "Yes! PDFSun offers generous free access to all 66+ tools with zero registration required.", isMultiLine: true },
