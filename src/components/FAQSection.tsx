...
export const FAQSection: React.FC<FAQSectionProps> = ({ activeTool }) => {
  ...
  const defaultFaqs = [
    ...
    },
    {
      ...
      a: t(
        "faq.a3",
        "Yes! PDFSun offers generous free access to all 66+ tools with zero registration required. For heavy power users who need high-capacity batch AI analysis or multi-gigabyte processing, Pro Sun plans are available."
      ),
    },
    {
