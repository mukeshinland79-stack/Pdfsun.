            ...
            {hasAdminRights ? (
              ...
              <div className="flex items-center space-x-1.5">
                <button
                  ...
                  className="hidden sm:flex items-center space-x-1.5 px-3 py-1.5 rounded-xl bg-amber-500/10 hover:bg-amber-500/20 text-amber-600 dark:text-amber-400 border border-amber-500/30 text-xs font-black transition cursor-pointer shadow-2xs"
                  title="Owner & Super Admin Portal"
                >
                  <Crown className="w-3.5 h-3.5 text-amber-500 fill-amber-500/20" />
                  <span className="uppercase tracking-wider text-[11px]">Owner</span>
                </button>
