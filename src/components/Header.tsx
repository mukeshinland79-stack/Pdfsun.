              ...
              {hasAdminRights ? (
                ...
                <div className="flex flex-wrap items-center space-x-1.5">
                  <button
                    ...
                    className="px-3 sm:px-4 py-1.5 rounded-xl bg-orange-600 hover:bg-orange-500 text-white text-xs font-bold transition shadow-xs flex items-center space-x-1.5 whitespace-nowrap cursor-pointer active:scale-95"
          ...
          {!isAuthenticated && (
            <div className="w-full pt-1">
              <button
                ...
                className="w-full p-2.5 rounded-xl bg-orange-600 hover:bg-orange-500 text-white font-bold text-xs flex items-center justify-center space-x-2 transition shadow-xs cursor-pointer"
              >
