...
export const SEOManager: React.FC<SEOManagerProps> = ({
  ...
  // Pricing SoftwareApplication & Product Schema
      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes! PDFSun offers 100% free access to all 66+ PDF tools including Merge PDF, Split PDF, Compress PDF, PDF to Word converter, and AI PDF tools with zero registration required."
          }
        },
        {
          "@type": "Question",
