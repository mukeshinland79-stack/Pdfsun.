...
export const LanguageSwitcher: React.FC<LanguageSwitcherProps> = ({
  ...
  return (
    <div className={`relative inline-block ${className}`} ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-64 p-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-xl z-50 animate-in fade-in slide-in-from-top-2 duration-150">
          ...
          {/* Primary Quick Toggle Languages: English, Spanish, French */}
          ...
          <div className="text-[10px] font-bold uppercase tracking-wider text-slate-400 px-2 py-1">
            All Supported ({SUPPORTED_LANGUAGES.length})
          </div>
