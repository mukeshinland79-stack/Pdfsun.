...
export const IN_MEMORY_TRANSLATIONS: Record<string, Record<string, any>> = {
  en: {
    ...
    hero: {
      ...
      or: "or",
      searchPlaceholder: "Search 66+ PDF & Document Tools (Ctrl+K)...",
    ...
    badges: {
      ...
      utilitiesTitle: "66+ Free Online PDF & Document Tools",
      ...
      tools50: "66+ Free Online PDF & Document Tools",
    ...
    faq: {
      ...
      a3: "Yes! PDFSun offers generous free access to all 66+ tools with zero registration required. For heavy power users who need high-capacity batch AI analysis or multi-gigabyte processing, Pro Sun plans are available.",
  ...
  hi: {
    ...
    hero: {
      ...
      or: "या",
      searchPlaceholder: "66+ पीडीएफ टूल्स खोजें (Ctrl+K)...",
    ...
    badges: {
      ...
      utilitiesTitle: "66+ फ्री ऑनलाइन पीडीएफ और दस्तावेज टूल्स",
    ...
    faq: {
      ...
      a3: "हाँ! PDFSun बिना किसी पंजीकरण या साइन-अप के सभी 66+ टूल्स तक उदार मुफ्त पहुंच प्रदान करता है। भारी बिजली उपयोगकर्ताओं के लिए जो उच्च क्षमता वाले बैच एआई विश्लेषण या मल्टी-गीगाबाइट प्रोसेसिंग चाहते हैं, उनके लिए प्रो सन प्लान उपलब्ध हैं।",
  ...
  es: {
    nav: {
      ...
      searchBtn: "Buscar más de 68 herramientas",
    ...
    hero: {
      ...
      or: "o",
      searchPlaceholder: "Buscar más de 68 herramientas PDF (Ctrl+K)...",
    ...
    badges: {
      ...
      utilitiesTitle: "Más de 66 herramientas PDF Pro",
      ...
      tools50: "66+ herramientas funcionales",
    ...
    faq: {
      ...
      a3: "¡Sí! PDFSun ofrece acceso gratuito generoso a todas las más de 68 herramientas sin necesidad de registrarse.",
  ...
  fr: {
    nav: {
      ...
      searchBtn: "Rechercher parmi 66+ outils",
    ...
    hero: {
      ...
      or: "ou",
      searchPlaceholder: "Rechercher parmi plus de 66 outils PDF (Ctrl+K)...",
    ...
    badges: {
      ...
      utilitiesTitle: "66+ Outils PDF Pro",
      ...
      tools50: "66+ Outils fonctionnels",
    ...
    faq: {
      ...
      a3: "Oui ! PDFSun offre un accès gratuit généreux à l'ensemble des plus de 68 outils sans inscription.",
  ...
  de: {
    ...
    hero: {
      ...
      or: "oder",
      searchPlaceholder: "66+ PDF-Tools durchsuchen (Ctrl+K)...",
    ...
    badges: {
      ...
      utilitiesTitle: "66+ Pro PDF-Tools",
      ...
      tools50: "66+ funktionierende Tools",
    ...
    faq: {
      ...
      a3: "Ja! PDFSun bietet großzügigen kostenlosen Zugang zu allen 66+ Tools ohne Registrierung.",
  ...
  ar: {
    ...
    hero: {
      ...
      or: "أو",
      searchPlaceholder: "ابحث في أكثر من 66 أداة PDF...",
    ...
    badges: {
      ...
      utilitiesTitle: "أكثر من 66 أداة PDF احترافية",
    ...
    faq: {
      ...
      a3: "نعم! يوفر PDFSun وصولاً مجانياً سخياً لجميع الأدوات الـ 66+ دون الحاجة لأي تسجيل.",
