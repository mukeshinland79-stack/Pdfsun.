...
export const IN_MEMORY_TRANSLATIONS: Record<string, Record<string, any>> = {
  en: {
    ...
    hero: {
      ...
      or: "or",
      searchPlaceholder: "Search 68+ PDF tools (Ctrl+K)...",
    ...
    badges: {
      ...
      utilitiesTitle: "68+ Pro PDF Utilities",
    ...
    faq: {
      ...
      a3: "Yes! PDFSun offers generous free access to all 68+ tools with zero registration required. For heavy power users who need high-capacity batch AI analysis or multi-gigabyte processing, Pro Sun plans are available.",
  ...
  hi: {
    ...
    hero: {
      ...
      or: "या",
      searchPlaceholder: "68+ पीडीएफ टूल्स खोजें (Ctrl+K)...",
    ...
    badges: {
      ...
      utilitiesTitle: "68+ प्रो पीडीएफ टूल्स",
    ...
    faq: {
      ...
      a3: "हाँ! PDFSun बिना किसी पंजीकरण या साइन-अप के सभी 68+ टूल्स तक उदार मुफ्त पहुंच प्रदान करता है। भारी बिजली उपयोगकर्ताओं के लिए जो उच्च क्षमता वाले बैच एआई विश्लेषण या मल्टी-गीगाबाइट प्रोसेसिंग चाहते हैं, उनके लिए प्रो सन प्लान उपलब्ध हैं।",
  ...
  es: {
    ...
    badges: {
      ...
      utilitiesTitle: "Más de 68 herramientas PDF Pro",
      ...
      tools50: "68+ herramientas funcionales",
  ...
  fr: {
    nav: {
      ...
      searchBtn: "Rechercher parmi 68+ outils",
    ...
    hero: {
      ...
      or: "ou",
      searchPlaceholder: "Rechercher parmi plus de 68 outils PDF (Ctrl+K)...",
    ...
    badges: {
      ...
      utilitiesTitle: "68+ Outils PDF Pro",
      ...
      tools50: "68+ Outils fonctionnels",
  ...
  de: {
    ...
    hero: {
      ...
      or: "oder",
      searchPlaceholder: "68+ PDF-Tools durchsuchen (Ctrl+K)...",
    ...
    badges: {
      ...
      utilitiesTitle: "68+ Pro PDF-Tools",
      ...
      tools50: "68+ funktionierende Tools",
    ...
    faq: {
      ...
      a3: "Ja! PDFSun bietet großzügigen kostenlosen Zugang zu allen 68+ Tools ohne Registrierung.",
  ...
  ar: {
    ...
    hero: {
      ...
      or: "أو",
      searchPlaceholder: "ابحث في أكثر من 68 أداة PDF...",
    ...
    badges: {
      ...
      utilitiesTitle: "أكثر من 68 أداة PDF احترافية",
    ...
    faq: {
      ...
      a3: "نعم! يوفر PDFSun وصولاً مجانياً سخياً لجميع الأدوات الـ 68+ دون الحاجة لأي تسجيل.",
